...
angular.module('angucomplete', [] )
    .directive('angucomplete', function ($parse, $http) {
        return {
            ...
            template: '<div class="angucomplete-hsearchStrolder">' +
            '<input id="{{id}}" ng-model="searchStr" type="text" autocomplete="off" placeholder="{{placeholder}}"' +
            ' class="{{inputClass}}" ng-keyup="keyPressed($event)"  />' +
            ...
            'ng-class="{\'angucomplete-selected-row\': $index == currentIndex}"><div ng-if="result.image && result.image != \'\'" ' +
            'class="angucomplete-image-holder"><img ng-src="{{result.image}}" class="angucomplete-image"/></div><div>{{result.title}}</div>' +
            ...
            controller: function ( $scope ) {
                ...
                $scope.pause = 500;
                $scope.minLength = 3;
               $scope.searchStr=$scope.autocopletetext;
